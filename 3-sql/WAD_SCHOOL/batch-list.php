...
<section class=" bg-gray-100 p-10 rounded-lg">
    ...
    <div class="flex justify-end items-center mb-3">
        <a href="./batch-create.php" class=" w-auto  py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600">Create Batch</a>
    </div>
                    ...
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-neutral-700">
                        <thead>
                            <tr>
                                ...
                                <th scope="col" class="px-6 py-3  text-xs font-medium text-gray-500 uppercase dark:text-neutral-500 text-end">course</th>
                        ...
                        <tbody class="divide-y divide-gray-200 dark:divide-neutral-700">
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800 dark:text-neutral-200 text-end" title="<?= $row["title"] ?>">
                                        <?= $row["short"] ?></td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800 dark:text-neutral-200 text-end"><?= date("Y-m-d", strtotime($row["start_date"])) ?></td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800 dark:text-neutral-200 text-end">
                                        <?= date("g A", strtotime($row["start_time"])) ?> -
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800 dark:text-neutral-200 text-end">
                                        <div class="inline-flex rounded-lg shadow-sm justify-end">
                                            ...
                                            </a> <a onclick="return confirm('are u sure to delete?')" href="./batch-delete.php?row_id=<?= $row["batch_id"] ?>" class="py-3 px-4 inline-flex items-center gap-x-2 -ms-px first:rounded-s-lg first:ms-0 last:rounded-e-lg text-sm font-medium focus:z-10 border border-gray-200 bg-white text-gray-800 shadow-sm hover:bg-gray-50 focus:outline-none focus:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-white dark:hover:bg-neutral-800 dark:focus:bg-neutral-800">
