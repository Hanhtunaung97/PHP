            ...
            <table class="table-auto w-full text-left whitespace-no-wrap">
                <thead>
                    <tr>
                        ...
                        <th class="px-4 py-3 title-font tracking-wider font-medium text-gray-900 text-sm bg-gray-100 text-end">Price</th>
                ...
                <tbody>
                    <?php foreach ($courses as $course) : ?>
                        <tr>
                            ...
                            <td class="px-4 py-3 text-lg text-gray-900 text-end"><?= $course['fee'] ?></td>
                            <td class="w-10 text-center">
                                <a href="<?= url('batch-delete', ["id" => $course['id']]) ?>" class="flex ml-auto text-white bg-red-500 border-0 py-2 px-6 focus:outline-none hover:bg-red-600 rounded">Delete</a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
